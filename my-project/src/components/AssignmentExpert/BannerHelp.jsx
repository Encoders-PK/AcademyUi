          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-16 lg:gap-20">
            ...
            <div className="text-white  md:w-[65%]">
              ...
              <p className="whitespace-pre-wrap font-semibold py-6 text-sm md:text-base lg:text-lg">
                Struggling with Your Assignments? Get Immediate Help from Highly
                Qualified Experts! Enjoy 24/7 Support, Plagiarism-Free Work, and
                Tailored Solutions for Every Subject. Achieve Top Grades with
                Academians® Trusted Professionals.
              </p>
