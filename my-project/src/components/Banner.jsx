...
// const Banner = () => {
//   return (
//     <div className="w-[75%] mx-auto py-[70px]">
//       <div className=" flex gap-60">
//         {/* left-container */}

//         <div className="text-white">
//           <h1 className="text-[#FFFFFF] text-2xl leading-tight">
...
//           <p className="whitespace-pre-wrap py-6">
...
//             <div className="flex items-center gap-1">
//               <FaCircleNotch color="#3B7F4E" />
//               <h1>Top Quality Work</h1>
//             </div>

//             <div className="flex items-center gap-1">
//               <FaCircleNotch color="#3B7F4E" />
//               <h1>Plagiarism Free</h1>
//             </div>

//             <div className="flex items-center gap-1">
//               <FaCircleNotch color="#3B7F4E" />
//               <h1>On time Deliver</h1>
//             </div>
//           </div>
...
//             <div className="bg-[#408955]  w-[200px] h-10 flex justify-center rounded-md">
//               <div className="flex items-center gap-2">
