...
// const ReviewBanner = () => {
//   return (
//     <div className="w-[75%] h-auto rounded-xl bg-[#F6F8FA] mx-auto my-20">
//       {/* main container */}
//       <div className="flex items-center  gap-60">
//         {/* left side  */}
//         <div className="w-[30%] text-[#020621] py-10 px-6">
...
//           <h1 className="text-xl text-[#878D98]">
...
//   </div>
//   <div className="text-sm text-[#878D98]">- 9.7/10</div>
// </div>
//           </div>

//           {/* button */}

//           <div className="bg-[#020621] w-[250px] h-auto py-3 rounded-lg mt-2 font-bold text-center text-[16px]  text-white">
//             WRITE A REVIEW
//           </div>
//         </div>
//       </div>
