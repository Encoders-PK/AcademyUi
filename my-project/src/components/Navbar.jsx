...
const Navbar = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#142A41] via-[#1B7995] to-[#142A41]  h-auto w-full py-8 md:mt-8">
      {/* main container */}
        ...
        <div className="hidden  md:flex items-center gap-4">
          <div className="bg-[#408955] w-[220px] h-[40px] flex px-2 rounded-md">
            <div className="flex items-center gap-1">
              <IoLogoWhatsapp className="text-3xl" />
              <h1 className="text-white uppercase font-bold">get 50% discount</h1>
            </div>
          </div>
        ...
        <div className="md:hidden bg-[#020621] w-full text-white px-4 py-8">
          ...
          <div>
            <div className="flex items-center border border-white gap-2">
              <IoHome size={20} />
              <div
                className="relative flex items-center gap-1 pb-4"
                onClick={toggleDropdown}
                ref={serviceRef}
              >
                <h1
