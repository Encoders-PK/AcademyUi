        ...
        <div className="md:w-[75%]  max-w-7xl mx-auto px-4 py-12">
          <div className="flex flex-col md:flex-row gap-8 md:gap-16 lg:gap-20">
            ...
            <div className="text-white  md:w-[65%]">
              ...
              Let Academians® Handle Your Assessment for You
              </h1>
              ...
              Feeling overwhelmed and saying, I need someone to do my university work? We’ve heard your cries for
              help, and Academians® UK is here to support you every step of the way.
              </p>
