        ...
        <div className="md:w-[75%]  max-w-7xl mx-auto px-4 py-12">
          <div className="flex flex-col md:flex-row gap-8 md:gap-16 lg:gap-20">
            ...
            <div className="text-white  md:w-[65%]">
              ...
              TOP NOTCH DISSERTATION HELP BY UK PhD EXPERTS
              </h1>
              ...
              Team Academians providing top quality Dissertation assistance to help students succeed in their academic career
              </p>
