        ...
        <div className="md:w-[75%]  max-w-7xl mx-auto px-4 py-12">
          <div className="flex flex-col md:flex-row gap-8 md:gap-16 lg:gap-20">
            ...
            <div className="text-white  md:w-[65%]">
              ...
              TOP NOTCH ESSAY HELP BY UK PhD EXPERTS
              </h1>
              ...
              Team Academians providing top quality essay assistance to help students succeed in their academic career
              </p>

              <div className="flex flex-wrap gap-4 py-4">
                <div className="flex items-center gap-1">
                  <LuSunMedium size={20} color="#F3C30E" />
                  <h1 className="text-sm md:text-base lg:text-lg font-semibold">24/7 Free Support</h1>
                </div>
                <div className="flex items-center gap-1">
                  <LuSunMedium size={20} color="#F3C30E" />
                  <h1 className="text-sm md:text-base lg:text-lg font-semibold">Best Price</h1>
                </div>
                <div className="flex items-center gap-1">
                  <LuSunMedium size={20} color="#F3C30E" />
                  <h1 className="text-sm md:text-base lg:text-lg font-semibold">100% Money Back Guarantee</h1>
                </div>
                <div className="flex items-center gap-1">
                  <LuSunMedium size={20} color="#F3C30E" />
                  <h1 className="text-sm md:text-base lg:text-lg font-semibold">Top Quality Work</h1>
                </div>
                <div className="flex items-center gap-1">
                  <LuSunMedium size={20} color="#F3C30E" />
                  <h1 className="text-sm md:text-base lg:text-lg font-semibold">Plagiarism Free</h1>
                </div>
                <div className="flex items-center gap-1">
                  <LuSunMedium size={20} color="#F3C30E" />
                  <h1 className="text-sm md:text-base lg:text-lg font-semibold">On time Deliver</h1>
                </div>
              </div>
              ...
              <div className="flex justify-center md:justify-start gap-4 py-4">
                <div className="bg-[#00000080] md:w-44 h-16 p-2 rounded-md border border-white">
                  <div className="flex items-center justify-between h-full">
                    <div>
                      <img src={ukwriters} className="w-8 h-8 md:w-9 md:h-9" alt="UK Writers" />
                    </div>
                ...
                <div className="bg-[#00000080]  md:w-44 h-16 p-2 rounded-md border border-white">
                  <div className="flex items-center justify-between h-full">
                    <div>
                      <img src={trustpilot} alt="TrustPilot" className="w-8 h-8 md:w-9 md:h-9" />
                    </div>
                    <div className="flex flex-col items-start">
                      <div className="flex items-center gap-1">
                ...
                <div className="bg-[#00000080]  md:w-44 h-16 p-2 rounded-md border border-white">
                  <div className="flex items-center justify-between h-full">
                    <div>
                      <img src={sitejabber} alt="SiteJabber" className="w-8 h-8 md:w-9 md:h-9" />
                    </div>
                    <div className="flex flex-col items-start">
                      <div className="flex items-center gap-1">
                        <h1 className="text-base font-bold">4.8</h1>
...
export default EssayHelpBanner;
